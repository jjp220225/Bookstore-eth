...
export default function Message({children, type="success", size="md"}) {
  ...
  const messageSizes = SIZES[size]

  return (
    <div className={`${BG_TYPE[type]} rounded-xl mb-3`}>
      <div className="max-w-7xl mx-auto py-2 px-1">
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-0 flex-1 flex items-center">
            <div className={`ml-3 ${messageSizes} font-medium ${TEXT_TYPES[type]}`}>
